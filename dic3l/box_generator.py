...
# --------------------------------------------------------------------------------------------------------------
#  调试用
# def save_images(img, transf, name):
#     # 保存带红框的原图
#     img_with_box = img.copy()
#     draw = ImageDraw.Draw(img_with_box)
#     i, j, h, w, info = transf[0]
#     # draw.rectangle([j, i, j + w, i + h], outline="red")
#     # i, j, h, w, info = transf[1]
#     # draw.rectangle([j, i, j + w, i + h], outline="yellow")
#     # i, j, h, w, info = transf[2]
#     # draw.rectangle([j, i, j + w, i + h], outline="black")
#     # img_with_box.save(name)
#     draw.rectangle([j, i, w, h], outline="red")
#     i, j, h, w, info = transf[1]
#     draw.rectangle([j, i, w, h], outline="yellow")
#     i, j, h, w, info = transf[2]
#     draw.rectangle([j, i, w, h], outline="pink")
#     img_with_box.save(name)
#
#
# def main():
...
#         box_jittering=box_jittering,
#         box_jittering_ratio=box_jittering_ratio,
#         iou_threshold=iou_threshold,
#         grid_based_box_gen=grid_based_box_gen
#     )
#
#     transf1 = torch.tensor([[92,   3, 406, 408,   True]])  # , [30, 40, 150, 150, True], [15, 25, 190, 190, False]
#     transf2 = torch.tensor([[73,  72, 427, 405,   False]])  # , [35, 45, 140, 140, False], [10, 20, 200, 200, False]
#     transf = [transf1, transf2]
#
#     spatial_boxes = box_generator.generate(transf)
#
#     print("Spatial Boxes 1:")
#     print(spatial_boxes[0])
#     save_images(Image.open(r'D:\其他对比学习方法\MoCo+local-feature-training\image1.png'),
#                             spatial_boxes[0], "1.png")
#     print("Spatial Boxes 2:")
#     print(spatial_boxes[1])
#     save_images(Image.open(r'D:\其他对比学习方法\MoCo+local-feature-training\image2.png'),
#                             spatial_boxes[1], "2.png")
#
