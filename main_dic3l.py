...
from dic3l.loader import (SAR_dataset, Compose, ColorJitter, Normalize, ToTensor, RandomResizedCrop,
                          RandomApply, GaussianBlur, RandomHorizontalFlip, TwoCropsTransform, RandomGrayscale, decompose_collated_batch)
from dic3l.box_generator import SCRLBoxGenerator
...
# dic3l specific configs:
parser.add_argument(
    "--dic3l-dim", default=128, type=int, help="feature dimension (default: 128)"
)
parser.add_argument(
    "--dic3l-k",
    default=65536,
...
parser.add_argument(
    ...
    default=0.999,
    type=float,
    help="dic3l momentum of updating key encoder (default: 0.999)",
)
parser.add_argument(
    "--dic3l-t", default=0.07, type=float, help="softmax temperature (default: 0.07)"
)

# options for dic3l v2
parser.add_argument("--mlp", action="store_true", help="use mlp head")
parser.add_argument(
    "--aug-plus", action="store_true", help="use dic3l v2 data augmentation"
)
...
def main_worker(npu, nnpus_per_node, args):
    ...
    #     traindir, dic3l.loader.TwoCropsTransform(transforms.Compose(augmentation))
    # )
